...
main:
	...
	mov r3,#(0x20001000 & 0xffff)
	movt r3,#(0x20001000 >> 16)

	mov r0, #128 ; turn on the left lamp
	strb r0, [r3]
	bl lightLamp

	mov r0, #0; reset points for player A and B
	strb r0, [r3, #1]
	strb r0, [r3, #2]

	mov r0, #0xff ; höger och serv
	strb r0, [r3, #3]
	strb r0, [r3, #4]

servLoop:
	ldrb r0, [r3, #4]
	cmp r0, #0 ; Loop until serve status changes to no serve
	bne servLoop

spelLoop:
	ldrb r2, [r3, #4]
	cmp r2, #0xFF ; Check if serve
	beq servLoop

	ldrb r2, [r3, #3]
	cmp r2, #0  ; Check if ball is moving left
	bne right

left:
	ldrb r0, [r3]
	lsl r0, r0, #1 ; move ball left
	bl lightLamp
	strb r0, [r3]
	b controllPoints
...
right:
	ldrb r0, [r3]
	lsr r0, r0, #1 ; move ball right
	bl lightLamp
	strb r0, [r3]

controllPoints:
	ands r0, r0, #0xFF ; Check if no ball on field
	beq givePoints

	mov r1, #1000
	bl DELAY ; wait 1 sec before doing spelLoop again
	b spelLoop
...
intgpiod:
	...
	mov r1, #0 ; change ball dir to left
	strb r1, [r0, #3]
	bx lr
...
intgpiof:
	...
	mov r1, #0xff ; cange ball dir to right
	strb r1, [r0, #3]
	bx lr
...
giveBPoints:
	...
	ldrb r0, [r1, #2] ; read points
	add r0, r0, #1 ; add 1 point
	strb r0, [r1, #2] ; store points
